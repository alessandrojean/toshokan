  ...
  <div class="grid grid-cols-2 gap-6" v-if="showNavigation">
    ...
    <router-link
      ...
      :class="[
        ...
        'group shadow bg-white dark:bg-gray-700 dark:hover:bg-gray-600 rounded-md p-3 flex items-center hover:shadow-md transition-shadow active:bg-gray-50 focus:outline-none focus-visible:ring-2 focus-visible:ring-offset-2 focus-visible:ring-offset-gray-50 dark:focus-visible:ring-offset-gray-900 focus-visible:ring-indigo-500'
      ]"
